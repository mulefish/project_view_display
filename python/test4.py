...
G.add_edges_from(
    [('src', 'index.js'),
     ('src', 'App.test.js'),
        ...
        ('pages', 'ABCDocuments'),
        ('pages', 'SecondPass'),
        ('pages', 'ForceDirectedGraph'),
        ('ABCDocuments', 'layout.js'),
        ('ABCDocuments', 'index.js'),
        ('ABCDocuments', 'redux'),
        ('SecondPass', 'layout.js'),
        ('SecondPass', 'logic.js'),
        ('SecondPass', 'Controls.js'),
        ('SecondPass', 'memory.js'),
        ('SecondPass', 'index.js'),
        ('Diagram', 'memory.js'),
        ('Diagram', 'Diagram.js'),
        ('FauxForce', 'layout.js'),
        ('FauxForce', 'logic.js'),
        ('FauxForce', 'Controls.js'),
        ('FauxForce', 'index.js'),
        ('FauxForce', 'ReadJson.js'),
        ('ForceDirectedGraph', 'layout.js'),
        ('ForceDirectedGraph', 'logic.js'),
        ('ForceDirectedGraph', 'Controls.js'),
        ('ForceDirectedGraph', 'index.js'),
        ('Home', 'layout.js'),
        ('Home', 'index.js'),
        ('redux', 'types.js'),
        ('redux', 'actions.js'),
